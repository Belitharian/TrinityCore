...
enum DLPCreatures
{
    ...
    NPC_MAGISTER_SARIEN                 = 69309,
    NPC_MAGISTRIX_VESARA                = 69310,
	NPC_ICE_WALL					    = 178819,
	NPC_WANTON_HOST				        = 183317,
    NPC_GALENDROR_WHITEWING             = 244537,
...
enum DLPData
{
    ...
    DATA_MAGISTER_SARIEN,
    DATA_MAGISTRIX_VESARA,
	DATA_SECRET_PASSAGE,
    DATA_PORTAL_TO_PRISON,
    DATA_PORTAL_TO_SEWERS,
    DATA_GALENDROR_WHITEWING,
	DATA_SCENARIO_PHASE
};
...
enum DLPSpells
{
    ...
    SPELL_FIREBALL_COSMETIC             = 237639,
    ...
    SPELL_FROST_NOVA_COSMETIC           = 283591,
    ...
    SPELL_SNOWY_WEATHER                 = 414247,
    SPELL_MASS_TELEPORT                 = 446636,
    SPELL_ARCANE_RAY                    = 298163,
    ...
    // Horde Illusion
    SPELL_HORDE_ILLUSION_1              = 193864,
    SPELL_HORDE_ILLUSION_REACTIONS      = 195838,
    SPELL_HORDE_ILLUSION                = 193970,

	SPELL_CHILLING_BLAST                = 1236344,
    SPELL_WHIRLWIND                     = 1270254,
    SPELL_FROST_NOVA                    = 1271623,
};
...
WaypointPath const RathaellaPath01 =
{
    PATH_RATHAELLA_01,
    {
        { 0 , -787.62f, 4289.38f, 719.80f, 3.29f },
        { 1 , -790.13f, 4289.03f, 719.80f, 3.29f },
        { 2 , -791.83f, 4293.01f, 719.80f, 1.76f },
        { 3 , -792.78f, 4297.28f, 719.80f, 1.79f },
        { 4 , -798.43f, 4296.72f, 719.80f, 3.29f },
        { 5 , -803.53f, 4297.07f, 719.80f, 2.72f },
        { 6 , -808.70f, 4303.36f, 720.18f, 1.86f },
        { 7 , -792.65f, 4306.62f, 727.28f, 0.19f },
        { 8 , -792.02f, 4303.20f, 727.28f, 4.85f },
        { 9 , -792.49f, 4298.60f, 727.28f, 4.81f },
        { 10, -789.68f, 4297.28f, 727.49f, 0.20f },
        { 11, -786.63f, 4297.97f, 728.97f, 0.21f },
        { 12, -781.63f, 4298.90f, 729.07f, 0.13f },
        { 13, -773.60f, 4300.01f, 729.07f, 0.45f },
        { 14, -771.34f, 4305.53f, 729.05f, 1.59f },
        { 15, -772.34f, 4312.50f, 729.05f, 1.82f },
        { 16, -773.95f, 4319.54f, 729.05f, 1.67f },
        { 17, -773.46f, 4323.00f, 729.04f, 1.06f },
        { 18, -771.61f, 4324.92f, 729.03f, 0.62f },
        { 19, -766.87f, 4327.40f, 729.05f, 0.45f },
        { 20, -763.05f, 4330.28f, 729.07f, 0.96f },
        { 21, -761.56f, 4333.57f, 729.07f, 1.30f },
        { 22, -761.33f, 4338.09f, 729.07f, 1.69f },
...
WaypointPath const RathaellaPath02 =
{
    PATH_RATHAELLA_02,
    {
        { 0 , -767.98f, 4366.10f, 728.16f, 1.07f },
        { 1 , -764.36f, 4374.96f, 727.64f, 1.18f },
        { 2 , -760.16f, 4385.81f, 727.35f, 1.28f },
        { 3 , -760.22f, 4393.08f, 727.30f, 1.83f },
        { 4 , -764.85f, 4399.75f, 728.53f, 2.40f },
        { 5 , -772.95f, 4406.71f, 732.00f, 2.45f },
        { 6 , -785.37f, 4417.97f, 737.79f, 2.32f },
        { 7 , -791.04f, 4424.86f, 738.41f, 2.16f },
        { 8 , -794.15f, 4433.51f, 738.23f, 1.72f },
        { 9 , -793.58f, 4441.55f, 737.79f, 1.17f },
        { 10, -787.97f, 4448.57f, 736.76f, 0.74f },
        { 11, -785.27f, 4451.50f, 736.29f, 1.30f },
        { 12, -787.07f, 4460.11f, 735.31f, 2.24f },
        { 13, -792.53f, 4464.04f, 735.01f, 2.44f },
...
WaypointPath const RommathPath01 =
{
    PATH_ROMMATH_01,
    {
        { 0 , -898.20f, 4545.18f, 706.06f, 0.21f },
        { 1 , -896.17f, 4545.25f, 706.06f, 0.00f },
        { 2 , -892.74f, 4544.54f, 706.04f, 5.83f },
        { 3 , -889.83f, 4542.13f, 706.05f, 5.43f },
        { 4 , -884.65f, 4537.16f, 706.17f, 5.77f },
        { 5 , -876.83f, 4532.60f, 706.37f, 5.67f },
        { 6 , -869.97f, 4526.40f, 706.72f, 5.43f },
        { 7 , -866.96f, 4522.56f, 706.60f, 5.22f },
        { 8 , -866.00f, 4520.08f, 706.10f, 4.91f },
        { 9 , -866.02f, 4517.44f, 706.10f, 4.51f },
        { 10, -868.07f, 4513.34f, 706.10f, 4.08f },
        { 11, -875.40f, 4503.94f, 706.10f, 4.08f },
        { 12, -877.07f, 4501.67f, 706.10f, 4.00f },
        { 13, -883.66f, 4496.70f, 706.10f, 3.70f },
        { 14, -889.56f, 4492.92f, 706.10f, 3.75f },
        { 15, -892.55f, 4490.53f, 706.10f, 3.85f },
        { 16, -897.72f, 4485.26f, 706.10f, 4.02f },
        { 17, -903.38f, 4477.20f, 706.10f, 4.18f },
        { 18, -907.52f, 4469.28f, 706.10f, 4.32f },
        { 19, -908.61f, 4466.26f, 706.10f, 4.40f },
        { 20, -910.42f, 4461.33f, 706.10f, 4.22f },
        { 21, -912.43f, 4458.21f, 706.10f, 4.08f },
        { 22, -918.77f, 4450.02f, 706.10f, 4.02f },
        { 23, -948.20f, 4415.15f, 706.35f, 3.96f },
        { 24, -950.47f, 4412.93f, 706.32f, 3.82f },
        { 25, -958.44f, 4407.01f, 709.62f, 3.76f },
        { 26, -970.07f, 4399.00f, 720.27f, 3.69f },
        { 27, -971.62f, 4398.08f, 721.23f, 3.61f },
        { 28, -973.34f, 4397.72f, 721.23f, 3.02f },
        { 29, -975.66f, 4398.88f, 721.23f, 2.37f },
        { 30, -979.81f, 4406.33f, 721.23f, 2.17f },
        { 31, -981.82f, 4409.07f, 721.23f, 1.99f },
        { 32, -982.15f, 4410.79f, 721.23f, 1.50f },
        { 33, -981.56f, 4412.44f, 721.23f, 1.00f },
        { 34, -977.49f, 4415.15f, 724.24f, 0.47f },
        { 35, -967.15f, 4420.29f, 733.22f, 0.46f },
        { 36, -963.78f, 4422.03f, 735.73f, 0.61f },
        { 37, -962.84f, 4423.48f, 735.73f, 1.34f },
        { 38, -962.74f, 4425.25f, 735.73f, 1.73f },
