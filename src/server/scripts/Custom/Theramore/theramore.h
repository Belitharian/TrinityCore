...
const Location SoldiersLocation[10] =
{
    {0, { -3776.84f, -4207.85f, 7.53f, 4.59f } },
    {0, { -3782.77f, -4207.09f, 7.56f, 4.86f } },
    {0, { -3789.14f, -4207.87f, 7.54f, 4.86f } },
    {0, { -3791.02f, -4199.92f, 7.80f, 4.81f } },
    {0, { -3785.69f, -4202.10f, 7.73f, 4.81f } },
    {0, { -3783.61f, -4196.84f, 7.84f, 4.68f } },
    {0, { -3778.27f, -4195.94f, 7.84f, 4.68f } },
    {0, { -3773.79f, -4198.11f, 7.82f, 4.68f } },
    {0, { -3780.29f, -4202.86f, 7.70f, 4.68f } },
    {0, { -3776.31f, -4202.95f, 7.70f, 4.68f } }
};

const float ArchmagesRelocate[6][4] =
{
    { -3677.44f, -4521.55f, 10.21f, 0.50f }, // Rhonin
    { -3787.11f, -4256.53f,  6.54f, 1.57f }, // Tari (Modified)
    { -3649.58f, -4369.21f,  9.57f, 0.69f }, // Amara
    { -3778.42f, -4256.45f,  6.45f, 1.57f }, // Thoder (Modified)
